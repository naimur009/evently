...
export const paymentService = async (req, res) => {
    try {
        ...
        const data = {
            ...
            success_url: `http://localhost:${config.PORT}/success/${transaction_id}`,
            fail_url: `http://localhost:${config.PORT}/fail/${transaction_id}`,
            cancel_url: `http://localhost:${config.PORT}/cancel/${transaction_id}`,
            ipn_url: `http://localhost:${config.PORT}/ipn`,
