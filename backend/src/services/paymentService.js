...
export const paymentService = async (req, res) => {
    try {
        ...
        const data = {
            ...
            success_url: `http://localhost:8080/success/${transaction_id}`,
            fail_url: `http://localhost:8080/fail/${transaction_id}`,
            cancel_url: `http://localhost:8080/cancel/${transaction_id}`,
